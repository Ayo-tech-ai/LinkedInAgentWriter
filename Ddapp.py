            ...
            try:
                ...
                if result is None:
                    ...
                    with tab1:
                        ...
                        # Copy button using streamlit-copy
                        st_copy_button(
                            result["linkedin_post"], 
                            "📋 Copy LinkedIn Post",
                            help="Click to copy the LinkedIn post to clipboard"
                        )
                    ...
                    with tab2:
                        ...
                        st_copy_button(
                            ...
                            "📋 Copy Facebook Post",
                            help="Click to copy the Facebook post to clipboard"
                        )
                    ...
                    with tab3:
                        ...
                        # Copy button using streamlit-copy
                        st_copy_button(
                            result["whatsapp_hook"], 
                            "📋 Copy WhatsApp Hook",
                            help="Click to copy the WhatsApp hook to clipboard"
                        )
                    ...
                    with tab4:
                        ...
                        if result["search_urls"]:
                            ...
                            st_copy_button(
                                url_text, 
                                "📋 Copy All URLs",
                                help="Click to copy all URLs to clipboard"
                            )
                            ...
                            for i, url in enumerate(result["search_urls"], 1):
                                ...
                                with col2:
                                    st_copy_button(
                                        url, 
                                        "📋",
                                        help=f"Click to copy URL {i} to clipboard"
                                    )
                        else:
